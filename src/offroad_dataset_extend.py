...
class OffRoadDatasetExtend(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        anchor_type = self.anchor_list[idx][4]
        return anchor_tensor, pos_sample_tensor, neg_sample_tensor, cur_frame_id, full_img, anchor_xy, pos_sample_xy, neg_sample_xy, anchor_type
